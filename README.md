...
Хочу отметить, что операции выполнены не на безупречном уровне, особенно умножение и, в большей степени, деление. Я не сумел реализовать их как хотел, алгоритмы для обработки прцоессов вышли некрепкие. Тем не менее, они все же есть, так что я все же решил их показать. 
